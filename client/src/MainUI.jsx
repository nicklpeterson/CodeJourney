...
export default class MainUI extends Component {
    ...
    render() {
        return (
            <div>
                <Editor onCodeUpdate={this.getVisualizationData}/>
                {/* <Visualization /> */}
                {/* <ForceDirectedGraph data={this.state.graphData}/> */}
                <FunctionalComponent data={this.state.graphData}/>

                {/* <ForceDirectedGraph links={this.state.links} nodes={this.state.nodes}/> */}
                {/* <ForceDirectedGraph links={this.state.graphData.links} nodes={this.state.graphData.nodes}/> */}
            </div>
        );
    }
}
